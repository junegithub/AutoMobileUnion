...
import com.fx.zfcar.training.adapter.AvatarGridViewAdapter
import com.fx.zfcar.training.adapter.BeforeEducationAdapter
import com.fx.zfcar.training.adapter.ContinueEducationAdapter
import com.fx.zfcar.training.adapter.SafetyEducationAdapter
import com.fx.zfcar.training.adapter.StudyProveItem
import com.fx.zfcar.training.viewmodel.SafetyTrainingViewModel
import com.fx.zfcar.training.widget.CertificateGenerator
...
class LearningCertificateFragment : BaseUserFragment() {
    ...
    private var beforeEduStateFlow = MutableStateFlow<ApiState<BeforeEducationCertificateData>>(
        ApiState.Idle)
